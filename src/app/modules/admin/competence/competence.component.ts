...
export class CompetenceComponent implements OnInit {
  ...
  private createCompetence(competence: Competence): void {
  ...
  public onSubmit(): void {
    if (this.isEditMode) {
      this.updateCompetence(this.currentCompetence);
    } else {
      this.createCompetence(this.currentCompetence);
    }
  ...
  updatePaginated() {
    this.filteredData = this.paginate(this.competences);
  }
