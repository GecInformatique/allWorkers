...
import { AdminSidebar, FreelancerSidebarItem, header } from '../models/page/sidebar-model';
...
export class ShareDataService {
  ...
  public ManageUsers: BehaviorSubject<Array<empprojects>> = new BehaviorSubject<Array<empprojects>>(this.empprojects);
  ...
  public ManageUsers1: BehaviorSubject<Array<freelancerlist>> = new BehaviorSubject<Array<freelancerlist>>(this.freelancer);
  ...
  public ManageUsers3: BehaviorSubject<Array<freeprojects>> = new BehaviorSubject<Array<freeprojects>>(this.freeprojects);
  ...
  public ManageUsers4: BehaviorSubject<Array<freelist>> = new BehaviorSubject<Array<freelist>>(this.freelist);
  ...
  public ManageUsers5: BehaviorSubject<Array<freecompleted>> = new BehaviorSubject<Array<freecompleted>>(this.freecompleted);
 ...
 /* public getSideBarData: BehaviorSubject<SideBarData[]> = new BehaviorSubject<SideBarData[]>(this.sideBar as unknown as SideBarData[]);
  public sidemenu = [
    {
      title: 'Dashboard',
  ...
  public getSidemenu: BehaviorSubject<SidemenuItem[]> = new BehaviorSubject<SidemenuItem[]>(this.sidemenu as unknown as SidemenuItem[]);
*/
  public Admin_sideBar: AdminSidebar[] = [
    {
      ...
      menu: [
        ...
        {
          menuValue: 'Competences',
          route: routes.admin_Competences,
          hasSubRoute: false,
          showSubRoute: false,
          icon: 'icon-copy',
          base: 'Competences',
        ...
        {
          menuValue: 'Conditions',
          route: routes.admin_Conditions,
          hasSubRoute: false,
          showSubRoute: false,
          icon: 'icon-copy',
          base: 'Conditions',
        ...
        {
          menuValue: 'Advertisements',
          route: routes.admin_advertisement,
          hasSubRoute: false,
          showSubRoute: false,
          icon: 'icon-users',
          base: 'advertisements',
        ...
        {
          menuValue: 'Formations',
          route: routes.admin_formation,
          hasSubRoute: false,
          showSubRoute: false,
          icon: 'icon-user-check',
          base: 'formations',
        ...
        {
          menuValue: 'Professions',
          route: routes.admin_profession,
          hasSubRoute: false,
          showSubRoute: false,
          icon: 'icon-clipboard',
          base: 'professions',
        ...
        {
          menuValue: 'Specialite',
          route: routes.admin_specialism,
          hasSubRoute: false,
          showSubRoute: false,
          icon: 'icon-user-check',
          base: 'specialisms',
  ...
  public getAdminSideBarData: BehaviorSubject<Array<string>> = new BehaviorSubject<Array<any>>(this.Admin_sideBar);
    ...
    },
  {
    ...
    },
    {
      ...
      hasSubRoute: false,
      icon: 'assets/img/icon/sidebar-icon-05.svg',
      routes: routes.freelancer_tasks,
      page: 'taches',
    },
    /*{
      title: 'Chat',
  ...
  public company_sidebar : FreelancerSidebarItem[] = [
    {
      title: 'Dashboard',
      icon: 'assets/img/icon/sidebar-icon-01.svg',
      routes: routes.company_dashboard,
      page: 'dashboards',
      hasSubRoute: false,
    },
    {
    ...
    },
  {
    ...
    },*/
    {
      ...
      hasSubRoute: false,
      icon: 'assets/img/icon/sidebar-icon-05.svg',
      routes: routes.company_profiles,
      page: 'portfolio',
    },
    {
      title: 'Mes taches',
