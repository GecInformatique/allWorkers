...
export class routes {
  ...
  public static get admin_Candidats(): string {
    return this.admin + '/candidats';
  }
  public static get admin_Competences(): string {
    return this.admin + '/competences';
  }
  public static get admin_Conditions(): string {
    return this.admin + '/conditions';
  }
  public static get admin_domain(): string {
  ...
  public static get admin_advertisement(): string {
    return this.admin + '/advertisements';
  }
  public static get admin_document(): string {
    return this.admin + '/documents';
  }
  public static get admin_formation(): string {
    return this.admin + '/formations';
  }
  public static get admin_profession(): string {
    return this.admin + '/professions';
  }
  public static get admin_payments(): string {
    return this.admin + '/paiments';
  }
  ...
  public static get admin_subscription(): string {
    return this.admin + '/subscription';
  }
  public static get admin_reviews(): string {
    return this.admin + '/reviews';
  }
  public static get admin_roles(): string {
    return this.admin + '/roles';
  }
  public static get admin_questions(): string {
    return this.admin + '/questions';
  }
  public static get admin_packages(): string {
    return this.admin + '/packages';
  }
  public static get admin_specialism(): string {
    return this.admin + '/specialisms';
  }
  public static get admin_users(): string {
  ...
  public static get candidatViewDetail(): string {
    return   '/pages/candidat-detail';
  }

  public static get candidatView(): string {
    return   '/pages/candidat-list';
  }

  public static get domainView(): string {
    return '/pages/domain-list';
  }
