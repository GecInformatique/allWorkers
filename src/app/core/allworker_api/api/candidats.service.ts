...
export class CandidatsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public candidatsMe(observe?: 'body', reportProgress?: boolean): Observable<Candidat>;
    public candidatsMe(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Candidat>>;
    public candidatsMe(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Candidat>>;
    public candidatsMe(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Candidat>('get',`${this.basePath}/candidats/me/`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    /**
     *
     * Recherche de candidats par compétence et domaine
     * @param query Terme de recherche (compétence ou domaine)
     * @param competence Filtrer par compétence spécifique
     * @param domaine Filtrer par domaine spécifique
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public candidatsSearch(query?: string, competence?: string, domaine?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Candidat>>;
    public candidatsSearch(query?: string, competence?: string, domaine?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Candidat>>>;
    public candidatsSearch(query?: string, competence?: string, domaine?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Candidat>>>;
    public candidatsSearch(query?: string, competence?: string, domaine?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (competence !== undefined && competence !== null) {
            queryParameters = queryParameters.set('competence', <any>competence);
        }
        if (domaine !== undefined && domaine !== null) {
            queryParameters = queryParameters.set('domaine', <any>domaine);
        }
